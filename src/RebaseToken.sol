...
contract RebaseToken is Ownable, ERC20, AccessControl, IRebaseToken {
    ...
    /**
     * @notice This is created to revoke the roles
     * @param _role The role to revoke
     * @param _account The account to revoke role from
     */
    function revokeMintAndBurnRole(bytes32 _role, address _account) external onlyOwner {
     ...
     * @return linearInterestBalance The interest that has accumulated since the last update
     */
    function _calculateAccumulatedInterestSinceLastUpdate(address _user)
        internal
        view
        returns (uint256 linearInterestBalance)
    {
